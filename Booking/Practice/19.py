"""
Given a set of components like A,B,C,D... And their ordered dependencies like
A -> B,C
B -> C
C -> D
find the dependencies for any given component "X".
"""
...
def dependencies(graph, x):
    table = dict(topological_sort(graph))
    if x in table:
        return table[x]

    return None

print dependencies(graph, "A")
